...
--Step 3: preprocess step 2 results to identify combination therapy using R code (data_split.R)
...
--Step 5: exclude patients who have major surgery or pregnant event
	...
	*/
	...
	where s04.person_id not in 
			(
			select person_id from exclude_surgery union all
...
--Step 6: identify pateints with predose and postdose blood pressure records
	...
	*/
	...
	where  sbppre.value_as_number is not null and dbppre.value_as_number is not null
	order by person_id ;
...
--Step 7: use Step 6 results to identify sequence of a drug per person using R code. (drug_sequence.R)
